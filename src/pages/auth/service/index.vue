    ...
    <d2-container>
        <template slot="header">
            <div class="filter-container">
                ...
                <el-button class="filter-item" type="primary" icon="search" @click="handleFilter" size="small">
                    搜索
                </el-button>
                <el-button class="filter-item" v-if="serviceManager_btn_add" style="margin-left: 10px;"
                           @click="handleCreate" type="primary" icon="edit" size="small">添加
                </el-button>
        ...
        <el-table :key='tableKey' :data="list" v-loading.body="listLoading" @current-change="handleDataCurrentChange"
                  size="small" stripe highlight-current-row style="width: 100%">
          ...
          <template slot-scope="scope" >
            ...
            <el-table-column fixed="right" align="center" label="操作" width="150">
                <template slot-scope="scope">
                    <el-button v-if="serviceManager_btn_edit" size="small" type="success"
                               @click="handleUpdate(scope.row)">编辑
                    </el-button>
                    <el-button v-if="serviceManager_btn_del" size="small" type="danger"
    ...
    export default {
        ...
        data() {
            return {
                ...
                dialogStatus: '',
                serviceManager_btn_clientManager: this.hasPermissions(['serviceManager:btn_clientManager']),
